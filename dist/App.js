const startButton = document.getElementById("show-form");
...
const sixthForm = document.getElementById('sixth-form');
const seventhForm = document.getElementById('seventh-form');
const studentSelect = document.getElementById('student-select');
const studiesInput = document.getElementById('studies-input');
const forms = document.querySelectorAll('form');
const studyTime = document.getElementById('study-time');
const degreeSelect = document.getElementById('degree-select');
const repeatedYearSelect = document.getElementById('repeated-year-select');
